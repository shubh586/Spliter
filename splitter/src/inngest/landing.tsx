...
type Feature ={
    title:string;
   Icon:React.ElementType //also React>ComponentType(allows props) and JSX.ElementType(component without props) and 
    //React.ElementType(omponents + tags like 'div', 'svg' )
    bg:string;
    color:string;
    description:string;
}
